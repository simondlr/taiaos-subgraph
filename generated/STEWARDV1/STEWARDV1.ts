...
export class STEWARDV1__patronageOwedWithTimestampResult {
  value0: BigInt;
  value1: BigInt;
...
export class STEWARDV1 extends ethereum.SmartContract {
  static bind(address: Address): STEWARDV1 {
    return new STEWARDV1("STEWARDV1", address);
  }
  ...
  patronageOwedWithTimestamp(): STEWARDV1__patronageOwedWithTimestampResult {
    let result = super.call(
    ...
    return new STEWARDV1__patronageOwedWithTimestampResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_patronageOwedWithTimestamp(): ethereum.CallResult<STEWARDV1__patronageOwedWithTimestampResult> {
    let result = super.tryCall(
      "patronageOwedWithTimestamp",
      "patronageOwedWithTimestamp():(uint256,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new STEWARDV1__patronageOwedWithTimestampResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
