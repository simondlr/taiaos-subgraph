...
export class STEWARDV2__patronageOwedWithTimestampResult {
  value0: BigInt;
  value1: BigInt;
...
export class STEWARDV2 extends ethereum.SmartContract {
  static bind(address: Address): STEWARDV2 {
    return new STEWARDV2("STEWARDV2", address);
  }
  ...
  patronageOwedWithTimestamp(): STEWARDV2__patronageOwedWithTimestampResult {
    let result = super.call(
