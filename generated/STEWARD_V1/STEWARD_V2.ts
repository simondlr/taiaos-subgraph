...
export class STEWARD_V2__patronageOwedWithTimestampResult {
  value0: BigInt;
  value1: BigInt;
...
export class STEWARD_V2 extends ethereum.SmartContract {
  static bind(address: Address): STEWARD_V2 {
    return new STEWARD_V2("STEWARD_V2", address);
  }
  ...
  patronageOwedWithTimestamp(): STEWARD_V2__patronageOwedWithTimestampResult {
    let result = super.call(
    ...
    return new STEWARD_V2__patronageOwedWithTimestampResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_patronageOwedWithTimestamp(): ethereum.CallResult<
    STEWARD_V2__patronageOwedWithTimestampResult
  > {
    let result = super.tryCall(
      "patronageOwedWithTimestamp",
      "patronageOwedWithTimestamp():(uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new STEWARD_V2__patronageOwedWithTimestampResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
